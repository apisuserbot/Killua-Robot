...
from KilluaRobot import telethn as bot
from KilluaRobot.modules.urluploader import download_file
from KilluaRobot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By *KilluaRobot*",
            )
        except Exception as e:
            traceback.print_exc()
