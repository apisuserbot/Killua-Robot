...
from KilluaRobot.__main__ import STATS, TOKEN, USER_INFO
from KilluaRobot.modules.sql import SESSION
import KilluaRobot.modules.sql.userinfo_sql as sql
from KilluaRobot.modules.disable import DisableAbleCommandHandler
from KilluaRobot.modules.sql.global_bans_sql import is_user_gbanned
from KilluaRobot.modules.sql.afk_sql import is_afk, set_afk
from KilluaRobot.modules.sql.users_sql import get_user_num_chats
from KilluaRobot.modules.helper_funcs.chat_status import sudo_plus
from KilluaRobot.modules.helper_funcs.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nOwner Of A Bot. Queen Of @tzypis. Bot Name Inspired From 'JoJo'."
        disaster_level_present = True
...
def stats(update: Update, context: CallbackContext):
    stats = (
        "❂ <b>Stats For <a href='https://t.me/TheKilluaRobot'>Killua Robot</a>:</b>\n"
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/Killua_Support)
"""
