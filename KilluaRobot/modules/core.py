...
from KilluaRobot import OWNER_ID, DEV_USERS
from KilluaRobot import TEMP_DOWNLOAD_DIRECTORY as path
...
async def Prof(event):
    ...
    the_plugin_file = "./KilluaRobot/modules/{}.py".format(input_str)
